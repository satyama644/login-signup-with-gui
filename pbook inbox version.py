        ...
        for part in email_message.walk():
            ...
            if 'plain' in content_type:
                ...
                pass
                 ...
                 text=soup.get_text()
                 lib1=Label(inb,text=from_)
                 lib1.pack()
                 lib2=Label(inb,text=date_)
                 lib2.pack()
                 lib3=Label(inb,text='to me')
                 lib3.pack()
                 lib4=Label(inb,text='subject : {}'.format(subject_))
                 lib4.pack()
                 lib5=Label(inb,text='message : {}'.format(text))
                 lib5.pack()
            else:
                pass
